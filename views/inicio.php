                    ...
                    <div class="col">
                        <div class="row-reverse">
                            <div class="col d-flex flex-column align-items-center text-center">
                                ...
                                <h2 class="pt-4 font-weight-bold">Bienvenido a Texfashion</h2>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="front front-background"
                                    ...
                                    <div class="card-body py-7 text-center">
                                        <i class="material-icons text-white text-4xl my-3">
                                            <span class="iconify" data-icon="mdi:people" data-width="75"></span>
                                        </i>
                        ...
                        <div class="rotating-card-container">
                            <div class="card card-rotate card-background card-background-mask-primary shadow-primary mt-md-0 mt-5">
                                <div class="front front-background"
                                    ...
                                    <div class="card-body py-7 text-center">
                                        <i class="material-icons text-white text-4xl my-3">
                                            <span class="iconify" data-icon="bi:briefcase" data-width="75"></span>
                                        </i>
                        ...
                        <div class="rotating-card-container">
                            <div class="card card-rotate card-background card-background-mask-primary shadow-primary mt-md-0 mt-5">
                                <div class="front front-background"
                                    ...
                                    <div class="card-body py-7 text-center">
                                        <i class="material-icons text-white text-4xl my-3">
                                            <span class="iconify" data-icon="ic:trending-up" data-width="75"></span>
                                        </i>
